<template>
  <!-- 主内容区 -->
  <div class="flex-1 flex flex-col bg-muted glass-effect overflow-y-auto">
    <!-- 标题区域 -->
    <div
        ...
        <div class="px-4 py-3 flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <button
              ...
              :class="post.is_liked_by_me ? 'text-red-500' : 'text-primary-text hover:text-red-500'"
              ...
              <div class="flex-1">
                <div class="bg-muted rounded-lg p-3">
                  <div class="flex items-center justify-between mb-1">
                    <span class="font-medium text-sm text-accent-text">{{ comment.username }}</span>
