  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <header class="border-b border-gray-200 bg-white">
      <div class="max-w-6xl mx-auto px-6 py-8">
        <button @click="$router.back()" class="mb-4 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded text-gray-700 font-medium flex items-center gap-2 transition-colors">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="p-5 flex-1 flex flex-col">
              <!-- Title (Description) -->
              <h3 class="text-base font-semibold text-gray-800 mb-2 line-clamp-2 group-hover:text-black transition-colors flex-1">
              ...
              <div class="flex items-center justify-between text-xs text-gray-400 border-t border-gray-100 pt-3">
                ...
                <div class="flex items-center gap-1 text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity">
...
const EyeIcon = createIcon(["M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z", "M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0-6 0"])
...
const getTagList = (tags) => {
  ...
  return tags.split(',').map(tag => tag.trim()).filter(tag => tag).slice(0, 5) // 最多显示5个标签
}
